...
{
    public partial class frm_mang_services_type : DevExpress.XtraEditors.XtraUserControl
    {
        public int services_type_id =0;
        ...
        void get_data()
        {
            ...
            dbContext.TBL_SERVICE_TYPE.LoadAsync().ContinueWith(loadTask =>
            {
                // Bind data to control when loading complete
                tBL_SERVICE_TYPEBindingSource.DataSource = dbContext.TBL_SERVICE_TYPE.Local.ToBindingList();
        ...
        {
            FRM_ADD_services_type FRM = new FRM_ADD_services_type();
            FRM.services_type_id = 0;
        ...
        {
            FRM_ADD_services_type FRM = new FRM_ADD_services_type();
            FRM.services_type_id= services_type_id ;
        ...
        void delete()
        {
            if (services_type_id  != 0)
            {
                try
                {
                    ...
                    {
                        TBL_SERVICE_TYPE del_cle = con.TBL_SERVICE_TYPE.Find(services_type_id );
                        // del_doc.DOC_ID = holiday_type_id;

                        con.TBL_SERVICE_TYPE.Remove(del_cle);
                        con.SaveChanges();
                        tost not = new tost();
        ...
        void get_sele()
        {
            if (gridView2.SelectedRowsCount > 0)
            {
                ...
                services_type_id  = Convert.ToInt32(gridView2.GetFocusedRowCellValue("SERVICE_TYPE_ID").ToString());
