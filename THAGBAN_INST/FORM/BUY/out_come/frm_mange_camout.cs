...
{
    public partial class     frm_mange_camout: DevExpress.XtraEditors.XtraUserControl
    {
        public int id=0;
        ...
        void get_data()
        {
            ...
            dbContext.TBL_OutCome.LoadAsync().ContinueWith(loadTask =>
            {
                // Bind data to control when loading complete
                gridControl1.DataSource = dbContext.TBL_OutCome.Local.ToBindingList();
        ...
        {
            FRM_ADD_camout FRM = new FRM_ADD_camout();
            FRM.out_id = 0;
        ...
        void delete()
        {
            if (id != 0)
            {
                try
                {
                    ...
                    {
                        TBL_OutCome del_cle = con.TBL_OutCome.Find(id);
                        // del_doc.DOC_ID = holiday_type_id;

                        con.TBL_OutCome.Remove(del_cle);
                        con.SaveChanges();
        ...
        private void txt_stor_name_TextChanged(object sender, EventArgs e)
        {

        }

        private void ch_add_new_CheckedChanged(object sender, EventArgs e)
        {
