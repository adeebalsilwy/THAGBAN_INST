...
{
    public partial class frm_mange_grievance : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        void get_data()
        {
            ...
            dbContext.TBL_GREIVANCES.LoadAsync().ContinueWith(loadTask =>
            {
                // Bind data to control when loading complete
                gridControl1.DataSource = dbContext.TBL_GREIVANCES.Local.ToBindingList();
        ...
        {
            FRM_ADD_grievance FRM = new FRM_ADD_grievance();
            FRM.griev_id = 0;
        ...
        void delete()
        {
            if (griev_id != 0)
            {
                try
                {
                    ...
                    {
                        TBL_GREIVANCES del_cle = con.TBL_GREIVANCES.Find(griev_id);
                        // del_doc.DOC_ID = holiday_type_id;

                        con.TBL_GREIVANCES.Remove(del_cle);
                        con.SaveChanges();
                        tost not = new tost();
        ...
        void get_sele()
        {
            if (gridView2.RowCount > 0)
            {
                ...
                griev_id = Convert.ToInt32(gridView2.GetFocusedRowCellValue("GREIVANCE_ID").ToString());
